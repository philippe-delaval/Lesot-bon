      ...
      <div class="flex items-center justify-between">
        <div>
            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
              ...
              <li>
                <div class="flex items-center">
                  ...
                  <Link :href="route('clients.index')" class="ml-1 text-gray-500 hover:text-gray-700">
                    Clients
                  </Link>
                </div>
              </li>
              <li>
                <div class="flex items-center">
                  <span class="text-gray-400">/</span>
                  <span class="ml-1 text-gray-900">Nouveau Client</span>
                </div>
              </li>
            </ol>
          </nav>
          ...
          <div class="flex items-center gap-3">
            ...
            <div>
              <h1 class="text-3xl font-bold tracking-tight text-gray-900">Nouveau Client</h1>
              <p class="text-sm text-gray-500">Ajouter un nouveau client à la base</p>
            </div>
          </div>
        </div>
